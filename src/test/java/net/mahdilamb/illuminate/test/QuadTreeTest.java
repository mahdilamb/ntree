...
public class QuadTreeTest<I extends Number> {
    ...
    final static QuadTree<Integer> quadTree = new QuadTree<>(new CollidableAABB(0, 0, width, height), 1, 10);
    static int i = 0;

    static void addRect(final CollidableAABB rect) {
        quadTree.add(rect, i++);
        if (frame.isVisible()) {
    ...
    public static void main(String... args) {
        ...
        MouseAdapter drawTool = new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                addRect(new CollidableAABB(x2, y2, x1 - x2, y1 - y2));
         ...
         * CollidableAABB(RandomUtils.nextInt(0,500),RandomUtils.nextInt(0,500),RandomUtils.nextInt
         * (0,100),RandomUtils.nextInt(0,100))); }
         */
        addRect(new CollidableAABB(10, 10, 10, 10));
        addRect(new CollidableAABB(260, 10, 10, 10));
        addRect(new CollidableAABB(260, 260, 10, 10));
        addRect(new CollidableAABB(10, 260, 10, 10));
